...
public class LittleGenome {
    ...
    // Comme dit précédemment, nous avons divisé le génome de toutes les missions en littleGenome
    // Notre minigénome est donc caractérisé par un centre, un skill et un jour
    ...
    // A partir de notre mini génome, on génère toutes les permutations d'employés identique
    // ça ne change donc pas le nombre d'affectation et le coût de tous les trajets
    ...
    // Ensuite on évalue toutes les versions du mini génome pour garder le meilleur
